...
export function buildSeatingWallAssembly(
  ...
  return {
    ...
    lines: [
      ...
      materialLine(2, "rebarFooting", '#3 Rebar (3/8" - 20\')', "roundUp((wallLength * 2) / 20)", id("seat-rebar-3-footing")),
      materialLine(3, "dobies", '3" x 3" dobies', "even(wallLength - 1)", id("seat-dobies")),
      laborLine(4, "footing", "Install footing or base and first run", "0.24575 * wallLength", "skilled"),
      materialLine(5, "redicreteFooting", "Redicrete concrete mix", "(wallLength * 0.5 * 1) * 1.5", id("seat-redicrete-footing")),
      materialLine(6, "block6x8Footing", "6 x 8 x 16 grey concrete block", "roundUp(wallLength / 1.33333333333333)", id("seat-block-6x8x16")),
      materialLine(7, "column6x8Footing", "16 x 8 x 16 grey column block", "2", id("seat-column-16x8x16-a")),
      laborLine(8, "setBlock", "Set block, grout, brown coat, paint and color coat", `0.42852 * ${face}`, "skilled"),
      materialLine(9, "block6x8Wall", "6 x 8 x 16 grey concrete block", "roundUp(((wallHeight - (2 / 3)) * wallLength) / 0.8889)", id("seat-block-6x8x16"), "1"),
      materialLine(10, "block8x4Wall", "8 x 4 x 16 grey concrete block", "roundUp(wallLength / 1.33333333333333)", id("seat-block-8x4x16")),
      materialLine(11, "column16x8Wall", "16 x 8 x 16 grey column block", "6", id("seat-column-16x8x16-b")),
      materialLine(12, "column16x4Wall", "16 x 4 x 16 grey column block", "2", id("seat-column-16x4x16")),
      materialLine(13, "rebarWall", '#3 Rebar (3/8" - 20\')', "roundUp(((wallHeight / 1.5) * wallLength) / 20)", id("seat-rebar-3-wall")),
      materialLine(14, "redicreteWall", "Redicrete concrete mix", `roundUp(0.25 * ${face})`, id("seat-redicrete-wall")),
      materialLine(15, "specMix", "Spec mix", `roundUp(0.166667 * ${face})`, id("seat-spec-mix")),
      materialLine(16, "stucco", "Stucco", "roundUp(((rebarFooting * 2.87) * 2) / 100)", id("seat-stucco")),
    ],
  };
}
